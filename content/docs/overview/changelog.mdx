...
**What's New**
- **@lifi/wdk-protocol-swidge-lifi** ([v0.3.0](https://www.npmjs.com/package/@lifi/wdk-protocol-swidge-lifi/v/0.3.0)): Add generated TypeScript declarations, request timeouts and retries, typed LI.FI error classes, input and transaction validation, optional trusted-contract checks, fee-cap handling, and default gasless route filtering for LI.FI swidge routes.
