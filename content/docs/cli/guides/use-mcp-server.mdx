...
description: Connect WDK CLI to Claude Desktop, Claude Code, or OpenClaw
docType: how-to
...
Install WDK CLI and create a wallet as described in [Get Started](/cli/guides/get-started/).
...
Use the WDK CLI MCP server when you want the bundled tool set, local wallet daemon, and setup commands for Claude Desktop, Claude Code, or OpenClaw.
