...
`wdk buy` and `wdk sell` derive the selected wallet address and create a provider URL. Both require an unlocked wallet and valid [MoonPay configuration](/cli/configuration#moonpay).
