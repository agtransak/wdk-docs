---
title: All Modules
description: Complete list of available WDK wallet, Smart Deposit Address, pricing, swidge, swap, bridge, lending, and fiat interfaces and modules.
docType: reference
...
## Smart Deposit Address Interface

The released `@tetherto/wdk-wallet` package includes the provider contract for Smart Deposit Address routes. It defines discovery, deposit-address creation, and optional quote, monitoring, renewal, recovery, and disable operations; it does not include a concrete SDA provider.

| Interface | Package | Description | Documentation |
|-----------|---------|-------------|---------------|
| `SdaProtocol` | [`@tetherto/wdk-wallet`](https://www.npmjs.com/package/@tetherto/wdk-wallet) | Abstract provider interface for route-bound deposit addresses | [Docs](/sdk/sda-modules/) |
