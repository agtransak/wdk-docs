...
| `wdk-mcp` | Exposes WDK CLI wallet operations to supported MCP clients |
...
| `wdk mcp` | Configure the bundled MCP server for a supported AI client |
...
| Bundled MCP server | Claude Desktop, Claude Code, or OpenClaw should call the CLI's structured wallet tools |
...
Create a wallet, derive an address, read its balance, and preview a transfer
</Card>
...
Connect the bundled MCP server to a supported AI client
</Card>
